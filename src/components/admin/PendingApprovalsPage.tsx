...
> = {
  ...
  initial: { label: "First initial only", tone: "bg-[#ffd100] text-[#8b0000]", icon: AlertTriangle },
  ambiguous: { label: "Ambiguous — multiple candidates", tone: "bg-red-100 text-red-600", icon: HelpCircle },
  no_first_name: { label: "No first name to compare", tone: "bg-red-100 text-red-600", icon: HelpCircle },
  ...
  return (
    <div
      className={`rounded-lg border p-3 text-sm ${
        isBest ? "border-gray-300 bg-gray-50" : "border-gray-200 bg-gray-50"
      }`}
    >
      <div className="flex items-center gap-2 flex-wrap">
        ...
        {isBest && (
          <span className="text-xs uppercase tracking-wide font-semibold text-[#8b0000]">
            Closest candidate
          </span>
        )}
      </div>
                  ...
                  <div className="mt-4 pt-4 border-t border-gray-100">
                    ...
                    <div className="flex gap-2">
                      <input
                        ...
                        className="flex-1 px-3 py-2 text-sm border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-2"
                      />
                      <button
